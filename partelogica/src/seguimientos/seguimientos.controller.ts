...
export class SeguimientosController {
  ...
  @ApiOperation({
    summary:
      'Registrar un nuevo evento de seguimiento y actualizar el estado general del envío de forma integrada',
  })
  @ApiResponse({
    status: 201,
    description: 'Seguimiento registrado y envío actualizado exitosamente.',
  })
  ...
  @ApiOperation({
    summary:
      'Obtener el historial completo de seguimiento de un envío ordenado por fecha de forma descendente',
  })
  @ApiResponse({
    status: 200,
    description: 'Historial de seguimiento devuelto exitosamente.',
  })
